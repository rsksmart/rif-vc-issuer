...
this project uses the DID Registry contract deployed on RSK, for the sake of this PoC, hardhat network is used to deploy this contract that servers as a on chain resource to validate VCs and VPs. You can find the code here. [ethr-did-registry](https://github.com/uport-project/ethr-did-registry)
